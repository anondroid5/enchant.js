...
var EFFECT_IMAGE = "http://github.com/phi1618/enchant.js/raw/v0.4.4/images/effect0.gif"
var ICON_IMAGE   = "http://github.com/phi1618/enchant.js/raw/v0.4.4/images/icon0.gif";
var FONT_IMAGE   = "http://github.com/phi1618/enchant.js/raw/v0.4.4/images/font2.png";

enchant.util = { assets: [EFFECT_IMAGE, ICON_IMAGE, FONT_IMAGE] };
...
enchant.util.MutableText = enchant.Class.create(enchant.Sprite, {
	...
	setText: function(txt) {
		...
		for(i=0; i<txt.length; i++) {
			...
			this.image.draw(enchant.Game.instance.assets[FONT_IMAGE], 
...
enchant.util.LifeLabel = enchant.Class.create(enchant.Group, {
	initialize: function(x, y, maxlife) {
		...
		for(var i=0; i<this._maxlife; i++){
			...
			this.heart[i].image = enchant.Game.instance.assets[ICON_IMAGE];
